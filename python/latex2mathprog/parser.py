...
precedence = (
    ...
    ('right', 'IF', 'THEN', 'ELSE'),
    ('left', 'OR'),
    ('left', 'FORALL', 'NFORALL', 'EXISTS', 'NEXISTS'),
    ('left', 'AND'),
...
def p_FunctionSymbolicExpression(t):
    '''SymbolicExpression : SUBSTR LPAREN Identifier COMMA Identifier COMMA Identifier RPAREN
                          ...
                          | TIME2STR LPAREN NumericSymbolicExpression COMMA Identifier RPAREN
                          | TIME2STR LPAREN NumericSymbolicExpression COMMA SymbolicExpression RPAREN'''
...
def p_FunctionNumericExpression(t):
    '''NumericExpression : SQRT LBRACE Identifier RBRACE
                         ...
                         | STR2TIME LPAREN Identifier COMMA NumericSymbolicExpression RPAREN
                         | STR2TIME LPAREN NumericSymbolicExpression COMMA Identifier RPAREN
                         | STR2TIME LPAREN NumericSymbolicExpression COMMA NumericSymbolicExpression RPAREN
